...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Reviewed expert replays         | `game-p4v0s415`: approved actions through move 36; `game-p4v0s1`: full user-supplied continuation revised from turn 18 on 2026-09-23; automated full-replay parity test removed at the user’s request; `game-p4v0s9`, `game-p4v0s2`, and `game-p4v0s3`: full action parity. All retain focused, reviewed interpretation tests. |
...
full-replay parity coverage remains for this seed. Original ledger hashes are
