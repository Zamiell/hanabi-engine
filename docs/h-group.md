...
7. From Level 8, conservatively prefer drawing an unseen connector when the next player holds its clued successor and can give the same non-urgent direct clue instead. Every possible discard identity must preserve that clue; unknown draws remain blank and ambiguous own cards stay ambiguous. The preference does not override plays, repairs, urgent saves, or low-pace constraints.
